...
class AdminOrdersControllerCore extends AdminController
{
	...
	public function __construct()
	{
		...
		LEFT JOIN '._DB_PREFIX_.'flexxus_codigo_cliente_erp erp ON (a.id_customer = erp.codigocliente_prestashop)
		LEFT JOIN '._DB_PREFIX_.'flexxus_codigo_cliente_vendedor cv ON (cv.codigocliente_erp = erp.codigocliente_erp)
		LEFT JOIN '._DB_PREFIX_.'flexxus_usuarios us ON (cv.codigocliente_vendedor = us.ID_ERP)';
		
		if($this->context->cookie->profile > 1)
			$this->_where = 'AND us.id_prestashop ="'.$this->context->cookie->id_employee.'"';
