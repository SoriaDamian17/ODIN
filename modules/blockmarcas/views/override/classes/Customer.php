...
class CustomerCore extends ObjectModel
{
	...
	public static function searchByName($query)
	{
		$sql = 'SELECT *
				...
				LEFT JOIN '._DB_PREFIX_.'flexxus_codigo_cliente_erp erp ON (c.id_customer = erp.codigocliente_prestashop)
		...
		if(Context::getContext()->employee->id > 1)
		$sql.= 'us.id_prestashop = '.Context::getContext()->employee->id.' AND';
