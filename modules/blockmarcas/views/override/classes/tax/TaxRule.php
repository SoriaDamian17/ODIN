...
class TaxRuleCore extends ObjectModel
{
    ...
    public static function getTaxRules($id_lang)
    {
        ...
        LEFT JOIN `'._DB_PREFIX_.'flexxus_equivalencia_tax` flxtax ON (g.`id_tax` = flxtax.`id_prestashop`)         
        ORDER BY g.`id_tax_rule` ASC'
        );
    }
