...
<div class="row" >
		<div class="col-sm-12">
				...
				<h4 class="page-title">
				Marcas
				<span type="button" class="btn btn-primary-outline btn-rounded waves-effect waves-light">{$manufacturer->getCount()}</span></h4>
		</div>
</div>
...
<div class="row">
  <div class="col-xs-12">
      <div class="card-box" style="{if isset($smarty.get.addManufacturer)}{else}display:none;{/if}">
          <div class="row m-t-50">
              <div class="col-sm-12 col-xs-12">
				<form id="wizard-vertical" class="formController" action="index.php?controller=AdminManufacturer&token={Tools::getToken('AdminManufacturer')}&addManufacturer" method="post">
                  <input type="hidden" value="{$manufacturer->id}" name="id" />
									...
									<section>
											<div class="form-group clearfix">
													...
													<div class="col-lg-10">
															<input class="form-control required" id="manufacturerName" name="manufacturerName" type="text">
													</div>
											</div>
											...
											<div class="form-group clearfix">
												...
												<div class="col-lg-10">
													<textarea id="textarea" class="form-control autoload_rte" maxlength="225" rows="3" placeholder="This textarea has a limit of 225 chars." name="description"></textarea>
												</div>
											</div>
											<div class="form-group clearfix">
									...
									<input type="hidden" name="{if isset($smarty.get.addManufacturer)}addM{else}updM{/if}" />
							</form>
							<!-- End #wizard-vertical -->
              </div>
          </div>
