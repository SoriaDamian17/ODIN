...
<a href="index.php?controller=AdminPagesCms&token={Tools::getToken('AdminPagesCms')}&addPagesCms" class="btn-floating btn-large waves-effect waves-light fixed"><i class="zmdi zmdi-plus"></i></a>