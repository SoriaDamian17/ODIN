...
<div class="row">
		<div class="col-sm-12">
				...
				<h4 class="page-title">Provincias <span type="button" class="btn btn-primary-outline btn-rounded waves-effect waves-light">{$total}</span></h4>
		</div>
</div>
                    ...
                    Your awesome text goes here.Your awesome text goes here.
								...
								<form id="wizard-vertical">
									...
									<section>
											...
											<div class="form-group clearfix">
													<label class="col-lg-2 control-label " for="codEan">Activo</label>
													<div class="col-lg-10">
