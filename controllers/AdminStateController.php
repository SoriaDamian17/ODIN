<?php
class AdminStateControllerCore
{
	public $name = 'AdminState';
	public $title = 'Order Data Integration | State';
	public $dir;
	public $context;
	public $alert;
	public $token;
	...
	public function renderList()
	{
		$this->context->smarty->assign(array(
				'Country' => new Country(),
				'State' => State::getStatesByIdCountry(44),
				'Zone' => new Zone(),
		));
